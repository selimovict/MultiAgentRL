...
if __name__ == '__main__':
    ...
    for Epizode in range(1000):
        ...
        while (not Done):
            ...
            Agent_1_Action = agent_1.choose_action2(agent_1.cur_belief, agent_2.cur_belief,agent_1.epsilon)
            Agent_2_Action = agent_2.choose_action2(agent_2.cur_belief, agent_1.cur_belief,agent_2.epsilon)
    ...
    #agent_1.model.save('Tiger_Model/Agent_1_Model_Agent_1NN_Agent_2ActionNN')
    #agent_2.model.save('Tiger_Model/Agent_2_Model_Agent_1NN_Agent_2ActionNN')